...
class _SchedulePageState extends State<SchedulePage> {
  ...
  Future<void> addOrUpdateSchedule({
    ...
    DateTime? selectedDate = schedule?['date'] != null && schedule!['date'] != ''
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (title.isEmpty || selectedTime == null || selectedDate == null) return;
  ...
  Future<void> deleteSchedule(int index) async {
    ...
    if (schedule['id'] != null) {
      await FirebaseFirestore.instance.collection('schedule').doc(schedule['id']).delete();
      await fetchSchedules();
    }
  }
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => addOrUpdateSchedule(schedule: schedule, index: index),
                            ),
                            IconButton(
